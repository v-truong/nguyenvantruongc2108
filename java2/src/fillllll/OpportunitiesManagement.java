...
public class OpportunitiesManagement {
  ...
  public void writeFile() {
    try {
      BufferedWriter bufferedWriter = new BufferedWriter(new FileWriter("D://hocjava//java2/src//fillllll//data_file.dat"));
  ...
  public void readFile() {
    try (BufferedReader bufferedReader = new BufferedReader(new FileReader("D://hocjava//java2/src//fillllll//data_file.dat"))) {
      String line;
